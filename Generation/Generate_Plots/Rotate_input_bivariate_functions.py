...
def plot_f1(a, k=np.sqrt(2)/2):
    ...
    ax.set_xlabel(r"$x_{1}$", font="CMU Serif", fontsize=16)
    ax.set_ylabel(r"$x_{2}$", font="CMU Serif", fontsize=16)
    ax.set_xticks(np.arange(-10, 10 + 1, 5.0))
    ax.set_yticks(np.arange(-10, 10 + 1, 5.0))
    ax.set_zlabel(r'$f^1(x_{1},x_{2})$', font="CMU Serif", fontsize=16)
    plt.tight_layout()
    ...
    ax.set_xticks(np.arange(-10, 10 + 1, 5.0))
    ax.set_yticks(np.arange(-10, 10 + 1, 5.0))
    ax.set_zlabel(r'$f_U^1(x_{1},x_{2})$', font="CMU Serif", fontsize=16)
    plt.tight_layout()
...
def plot_f2(a, k=6):
    ...
    ax.set_zlabel(r'$f^2(x_1, x_2)$', font="CMU Serif", fontsize=16)
    ...
    cbar.ax.set_ylabel(r"$\partial_{x_1}f^2(x_1, x_2)$", font="CMU Serif", fontsize=16)
    ...
    ax.set_xlabel(r"$x_{1}$", fontsize=16)
    ax.set_ylabel(r"$x_{2}$", fontsize=16)
    ax.set_zlabel(r'$f_U^2(x_1, x_2)$', font="CMU Serif", fontsize=16)
    ax.set_xticks(np.arange(-1, 1 + 1, 0.5))
    ax.set_yticks(np.arange(-1, 1 + 1, 0.5))
    ...
    cbar = fig.colorbar(cs)
    cbar.ax.set_ylabel(r"$\partial_{x_1}f_U^2(x_1, x_2)$", font="CMU Serif", fontsize=16)
    plt.xticks(np.arange(-1, 1.02, 0.5))
    plt.yticks(np.arange(-1, 1.02, 0.5))
...
if __name__ == '__main__':
    a = math.pi/4
    root = dirname(dirname(dirname(abspath(__file__)))) + '/Plots/Bivariate_functions'
    print(root)
    plot_f1(a)
    plot_f2(a)
    plt.show()